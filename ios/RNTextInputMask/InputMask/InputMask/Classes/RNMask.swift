...
open class RNMask : NSObject {
    @objc public static func maskValue(text: String, format: String, autoComplete: Bool = true) -> String {
    ...
    @objc public static func unmaskValue(text: String, format: String, autoComplete: Bool = true) -> String {
        let mask : Mask = try! Mask.getOrCreate(withFormat: format)
